...
import {ensure_timestamp} from 'mixpanel/lib/utils.js';

export function merge_modifiers(data, modifiers) {
    if (modifiers) {
...
export const ProfileHelpers = (Base = Object) => class extends Base {
    get token() {
